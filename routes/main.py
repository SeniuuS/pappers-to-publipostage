...
from services.country_service import get_activities, get_legal_forms, get_legal_situations, get_postal_codes, \
    get_region_codes, get_activities_group
...
def index_with_error(error: Exception):
    ...
    if error:
        return render_template('index.jinja2', country=country, legal_situations=legal_situations, activities_group=activities_group,
    ...
    return render_template('index.jinja2', country=country, legal_situations=legal_situations, legal_forms=legal_forms,
                           activities_group=activities_group, activities=activities, postal_codes=postal_codes, region_codes=region_codes,
                           form=current_form)
